...
const fetchData = async ()=>{
    ...
    await axios.get('http://127.0.0.1/tomato/tomatoBackend/getUsers.php').then(response=>{
        users = response.data
    })
...
async function remove(id){
    ...
    form.append('id', id)
    await axios.post('http://127.0.0.1/tomato/tomatoBackend/removeUser.php', form).then(response=>
        location.reload()
    )
 }
